...
void AMyProjectCharacter::StartUDPReceiver(const FString& YourChosenSocketName, const FString& TheIP, const int32 ThePort, bool& success) // 接收器初始化  接收信息前  
{
...
void AMyProjectCharacter::DataRecv(FString& str, bool& success)              //接收消息处理  
{
	if (!ListenSocket)
	{
